    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                ...
                <a href="https://github.com/salmamhamid22/salmamhamid22.github.io" target="_blank" rel="noreferrer"><h2>Jeu (En Attente)</h2></a>
                <p>Description du projet de jeu en attente de développement ou de lancement.</p>
            </div>
            <div className="project">
